...
function TreeNode({
    ...
    return (
      <div>
        <button
          ...
          className={cn(
            "flex items-center gap-1.5 w-full px-2 py-1 text-sm hover:bg-secondary/80 transition-colors text-left",
            "text-foreground/90"
          )}
  ...
  return (
    <button
      ...
      className={cn(
        "flex items-center gap-1.5 w-full px-2 py-1 text-sm transition-colors text-left",
        isSelected
